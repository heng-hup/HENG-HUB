...
function App() {
  ...
  // เช็คว่าถ้าอยู่หน้าแชท ให้ hideNav เป็น true
  const hideNav = location.pathname === '/chat';

  return (
    <div style={styles.appShell}>
       <div style={hideNav ? styles.contentFull : styles.contentArea}>
          <Routes>
       ...
       {/* แสดงเมนู 5 ปุ่ม เฉพาะเมื่อไม่ใช่หน้าแชท */}
       {!hideNav && (
...
const styles = {
  ...
  contentFull: { flex: 1, overflowY: 'auto' }, // หน้าแชทขยายเต็มจอ
