...
exports.getCommonTableVals = exports.reportMerge = exports.warnDeprecatedTask = exports.warnParallel = exports.warnReportFormat = exports.warnEthers = exports.warnUnsupportedChainConfig = exports.warnBlobBaseFeeRemoteCallFailed = exports.warnBaseFeeRemoteCallFailed = exports.warnGasPriceRemoteCallFailed = exports.warnCMCRemoteCallFailed = exports.costIsBelowPrecision = exports.getSmallestPrecisionVal = exports.markdownItalic = exports.markdownBold = exports.entitleMarkdown = exports.indentMarkdownWithSymbol = exports.indentTextWithSymbol = exports.indentMarkdown = exports.indentText = void 0;
...
function warnBlobBaseFeeRemoteCallFailed(err, url) {
    return `${startWarning}${os_1.EOL}${chalk_1.default.bold(`Failed to get L1 blob base fee from ${url}`)}${os_1.EOL}${remoteCallEndMessage(err)}`;
}
...
function getCommonTableVals(options) {
    ...
    let token = "";
    let l1gwei = (usingL1) ? options.gasPrice : options.baseFee;
    let l2gwei = (usingL1) ? "" : options.gasPrice;
    const l1gweiNote = (usingL1) ? "" : "(baseFee)";
